...
import com.ultimobiletools.commons.models.AlarmSound
import com.ultimobiletools.commons.models.BlockedNumber
import com.ultimobiletools.commons.helpers.PREFS_KEY
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.ultimobiletools.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.ultimobiletools.thankyou")
...
fun Context.isAProApp() = packageName.startsWith("com.ultimobiletools.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.ultimobiletools."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.ultimobiletools.contacts") && !packageName.startsWith("com.ultimobiletools.dialer")) {
        true
    } else if ((packageName.startsWith("com.ultimobiletools.contacts") || packageName.startsWith("com.ultimobiletools.dialer")) && isQPlus()) {
...
fun Context.copyToClipboard(text: String) {
    val clip = ClipData.newPlainText(getString(R.string.ulti_commons), text)

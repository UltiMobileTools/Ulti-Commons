...
import com.ultimobiletools.commons.asynctasks.CopyMoveTask
import com.ultimobiletools.commons.compose.extensions.DEVELOPER_PLAY_STORE_URL
import com.ultimobiletools.commons.dialogs.*
import com.ultimobiletools.commons.dialogs.WritePermissionDialog.WritePermissionDialogMode
import com.ultimobiletools.commons.extensions.*
import com.ultimobiletools.commons.helpers.*
import com.ultimobiletools.commons.interfaces.CopyMoveListener
...
abstract class BaseUltiActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!packageName.startsWith("com.ultimobiletools.", true)) {
            if ((0..50).random() == 10 || baseConfig.appRunCount % 100 == 0) {
                val label = "You are using a fake version of the app. For your own safety download the original one from www.ultimobiletools.com. Thanks"
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        hideKeyboard()
        return if (!packageName.startsWith("com.ultimobiletools")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.ultimobiletools.")

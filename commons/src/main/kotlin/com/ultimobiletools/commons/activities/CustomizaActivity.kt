...
import com.ultimobiletools.commons.databinding.ActivityCustomizationBinding
...
class CustomizaActivity : BaseUltiActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        isThankYou = packageName.removeSuffix(".debug") == "com.ultimobiletools.thankyou"
        initColorVariables()
...
//                        )
    ...
    private fun themePickerClicked() {
        ...
        RadioGroupDialog(this@CustomizaActivity, items, curSelectedThemeId) {
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.ultimobiletools.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }

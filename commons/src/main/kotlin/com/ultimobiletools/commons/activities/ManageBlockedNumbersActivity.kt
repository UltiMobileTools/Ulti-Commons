...
import com.ultimobiletools.commons.dialogs.AddOrEditBlockedNumberAlertDialog
import com.ultimobiletools.commons.dialogs.ExportBlockedNumbersDialog
import com.ultimobiletools.commons.dialogs.FilePickerDialog
...
import com.ultimobiletools.commons.helpers.APP_ICON_IDS
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("com.ultimobiletools.dialer")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.ultimobiletools.dialer")) {

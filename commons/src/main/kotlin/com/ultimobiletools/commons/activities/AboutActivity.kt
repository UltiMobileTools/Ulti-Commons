...
import com.ultimobiletools.commons.dialogs.ConfirmationAdvancedAlertDialog
...
class AboutActivity : ComponentActivity() {
    ...
    private fun launchEmailIntent() {
        ...
        val address = if (packageName.startsWith("com.ultimobiletools")) {
    ...
    private fun onFacebookClick() {
        var link = "https://www.facebook.com/ultimobiletools"
        try {
    ...
    private fun onGithubClick() {
        launchViewIntent("https://github.com/ultimobiletools")
    }
    ...
    private fun onTelegramClick() {
        launchViewIntent("https://t.me/ultimobiletools")
    }


    private fun onWebsiteClick() {
        launchViewIntent("https://ultimobiletools.com/")
    }

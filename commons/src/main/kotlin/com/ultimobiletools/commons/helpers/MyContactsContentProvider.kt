...
import com.ultimobiletools.commons.extensions.getIntValue
...
class MyContactsContentProvider {
    companion object {
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.ultimobiletools.dialer" && packageName != "com.ultimobiletools.smsmessenger" && packageName != "com.ultimobiletools.calendar.pro") {
                return contacts
            }

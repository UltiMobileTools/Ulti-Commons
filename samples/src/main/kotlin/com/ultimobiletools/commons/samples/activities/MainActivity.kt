...
import com.ultimobiletools.commons.dialogs.DonateAlertDialog
import com.ultimobiletools.commons.dialogs.RateStarsAlertDialog
import com.ultimobiletools.commons.extensions.hideKeyboard
import com.ultimobiletools.commons.extensions.launchMoreAppsFromUsIntent
...
class MainActivity : ComponentActivity() {
                ...
                MainScreen(
                    ...
                    openTestButton = {
                        ConfirmationDialog(
                            ...
                            positive = com.ultimobiletools.commons.R.string.ok,
                            negative = 0
                        ) {
    ...
    private fun launchAbout() {
        ...
        val faqItems = arrayListOf(
            FAQItem(com.ultimobiletools.commons.R.string.faq_1_title_commons, com.ultimobiletools.commons.R.string.faq_1_text_commons),
            FAQItem(com.ultimobiletools.commons.R.string.faq_1_title_commons, com.ultimobiletools.commons.R.string.faq_1_text_commons),
            FAQItem(com.ultimobiletools.commons.R.string.faq_4_title_commons, com.ultimobiletools.commons.R.string.faq_4_text_commons)
        )

        if (!resources.getBoolean(com.ultimobiletools.commons.R.bool.hide_google_relations)) {
            faqItems.add(FAQItem(com.ultimobiletools.commons.R.string.faq_2_title_commons, com.ultimobiletools.commons.R.string.faq_2_text_commons))
            faqItems.add(FAQItem(com.ultimobiletools.commons.R.string.faq_6_title_commons, com.ultimobiletools.commons.R.string.faq_6_text_commons))
        }
